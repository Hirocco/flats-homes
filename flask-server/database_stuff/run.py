...
if __name__ == '__main__':
    ...
    api.add_resource(GetAllProperty, '/getallproperty')
    api.add_resource(GetProperty, '/getproperty/<int:id_property>')
    api.add_resource(DeleteProperty, '/deleteproperty/<int:id_property>')
    api.add_resource(UpdateProperty, '/updateproperty/<int:property_id>')
    ...
    api.add_resource(PostFavourite, '/postfavourite/<int:id_user>/<int:id_property>')
    api.add_resource(DeleteFavourite, '/deletefavourite/<int:id_user>/<int:id_property>')
    api.add_resource(GetUserFavourite, '/getfavourite/<int:id_user>')
